...
export class FacturaUpdateComponent implements OnInit {
  ...
  updateForm(factura: IFactura): void {
    this.editForm.patchValue({
      ...
      valor: factura.valor,
      fachaPago: factura.fachaPago ? factura.fachaPago.format(DATE_TIME_FORMAT) : null
    });
  }
  ...
  private createFromForm(): IFactura {
    return {
      ...
      fachaPago: this.editForm.get(['fachaPago'])!.value ? moment(this.editForm.get(['fachaPago'])!.value, DATE_TIME_FORMAT) : undefined
    };
  }
